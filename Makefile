...
test: $(target)
	...
	OMP_SCHEDULE=static OMP_NUM_THREADS=8 ./$(target) 8000 0.1 60
	@echo "Test completato!"

test_all_1_0: $(target)
	@echo "--- Test con 1000 corpi, dt = 0.1 e T = 60 ---"
	@for t in 1 2 4 8 12; do \
		echo "--- Esecuzione con $$t thread ---"; \
		OMP_NUM_THREADS=$$t ./$(target) 1000 0.1 60; \
	done
	@echo "Test completati!"

test_all_multi_1_0: $(target)
	@echo "--- Test con 1000 corpi, dt = 0.1 e T = 60 ---"
	@for t in 1 2 4 8 12; do \
		echo "--- Esecuzione con $$t thread ---"; \
...
test_all_2_0: $(target)
	...
	@for t in 1 2 4 8 12; do \
		echo "--- Esecuzione con $$t thread ---"; \
		OMP_NUM_THREADS=$$t ./$(target) 2000 0.1 60; \
	done
	@echo "Test completati!"

test_all_multi_2_0: $(target)
	@echo "--- Test con 2000 corpi, dt = 0.1 e T = 60 ---"
	@for t in 1 2 4 8 12; do \
		echo "--- Esecuzione con $$t thread ---"; \
		for i in $$(seq 1 10); do \
...
test_all_4_0: $(target)
	...
	@for t in 1 2 4 8 12; do \
		echo "--- Esecuzione con $$t thread ---"; \
		OMP_NUM_THREADS=$$t ./$(target) 4000 0.1 60; \
	done
	@echo "Test completati!"

test_all_multi_4_0: $(target)
	@echo "--- Test con 4000 corpi, dt = 0.1 e T = 60 ---"
	@for t in 1 2 4 8 12; do \
		echo "--- Esecuzione con $$t thread ---"; \
		for i in $$(seq 1 10); do \
...
test_all_8_0: $(target)
	...
	@for t in 1 2 4 8 12; do \
		echo "--- Esecuzione con $$t thread ---"; \
		OMP_NUM_THREADS=$$t ./$(target) 8000 0.1 60; \
	done
	@echo "Test completati!"

test_all_multi_8_0: $(target)
	@echo "--- Test con 8000 corpi, dt = 0.1 e T = 60 ---"
	@for t in 1 2 4 8 12; do \
		echo "--- Esecuzione con $$t thread ---"; \
		for i in $$(seq 1 10); do \
...
test_all_multi_12_0: $(target)
	@echo "--- Test con 12000 corpi, dt = 0.1 e T = 60 ---"
	@for t in 1 2 4 8 12; do \
		echo "--- Esecuzione con $$t thread ---"; \
		for i in $$(seq 1 10); do \
			OMP_NUM_THREADS=$$t ./$(target) 12000 0.1 60; \
		done \
	done
	@echo "Test completati!"
